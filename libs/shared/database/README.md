...
Shared database library for iptvmate providing Drizzle ORM schema and connection utilities.
...
The SQLite database is stored at: `~/.iptvmate/databases/iptvmate.db`
