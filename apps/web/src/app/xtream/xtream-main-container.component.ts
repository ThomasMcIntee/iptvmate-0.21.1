...
export class XtreamMainContainerComponent implements OnInit, OnDestroy {
    ...
    addToFavorites(item: any) {
        ...
        this.playlistService
            .addPortalFavorite(playlist._id, item)
            .subscribe(() => {
                this.snackBar.open(
    ...
    removeFromFavorites(favoriteId: number) {
        ...
        if (!playlist || !playlist._id) return;
        this.playlistService
            .removeFromPortalFavorites(playlist._id, favoriteId)
            .subscribe(() => {
                this.snackBar.open(
