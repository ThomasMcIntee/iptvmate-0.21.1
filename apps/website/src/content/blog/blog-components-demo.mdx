...
description: Reusable MDX components for iptvmate blog posts including alerts, CTA buttons, and terminal command blocks.
pubDate: 2026-02-15
author: 4gray
tags:
- blog
...
<CopyCommand title="One-line fix" command="xattr -c /Applications/iptvmate.app" />
...
<PostButton
  href="/iptvmate/blog/v0-18-release-notes/"
...
<ImageGallery
  ...
  images={[
    {
      src: '/iptvmate/blog/iptvmate-v18.jpeg',
      alt: 'iptvmate v0.18 UI screenshot',
      caption: 'v0.18 interface update',
    },
    {
      src: '/iptvmate/blog/macos-app-damaged.jpg',
...
<BlogImageSlider
  images={[
    ...
    {
      src: '/iptvmate/blog/epg.png',
      alt: 'EPG guide screenshot',
      caption: 'Electronic Program Guide screen in iptvmate.',
    },
  ]}
/>
